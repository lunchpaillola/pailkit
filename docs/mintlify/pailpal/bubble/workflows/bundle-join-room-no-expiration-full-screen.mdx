---
title: "Bundle Join Daily Room (Full Screen, No Expiration)"
description: "A workflow that creates and joins a full-screen video call room without expiration, using the Video, Audio & Live Bundle."
---
...
This workflow **creates and joins a Daily video call room in full-screen mode** with **no expiration**.

It works like the free version but **leverages the video, audio, and live bundle**.
...
<Steps>
  <Step title="Find the workflow">
    ...
    Daily Room (Full-Screen, No Expiration)"**.
  </Step>
