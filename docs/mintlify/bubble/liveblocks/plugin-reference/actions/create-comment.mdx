...
description: "Use this action to create a comment in a thread."
---
...
| ------------- | -------- | ------------------------------------------------------- |
| **Room ID**   | Text     | The ID of the room where the comment will be created.   |
| **Thread ID** | Text     | The ID of the thread where the comment will be added.   |
| **User ID**   | Text     | The unique identifier of the user creating the comment. |
| **Text**      | Text     | The content of the comment to be added to the thread.   |
